/**
 * Erzeugt Wolken über die gesamte Levelbreite.
 *
 * @function generateClouds
 * @param {number} levelWidth - Breite des Levels in Pixeln.
 * @param {number} [spacing=500] - Abstand zwischen Wolken (je kleiner, desto mehr Wolken).
 * @returns {Cloud[]} Array aus Cloud-Objekten mit leicht zufälligem X-Offset.
 */
...
/**
 * Level 1 – enthält Gegner, Wolken und Hintergrund-Objekte.
 *
 * @type {Level}
 */
